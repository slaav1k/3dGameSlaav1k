...
public class MainMenuScreen implements Screen {
    ...
    private void configureWidgers() {
        ...
        titleImage.setPosition(Core.VIRTUAL_WIDTH / 2 - titleImage.getWidth()
                        / 2, Core.VIRTUAL_HEIGHT / 2);
        playButton.setSize(128, 64);
        playButton.setPosition(Core.VIRTUAL_WIDTH / 2 - playButton.getWidth()
                        / 2, Core.VIRTUAL_HEIGHT / 2 - 100);
        ...
        quitButton.setPosition(Core.VIRTUAL_WIDTH / 2 - playButton.getWidth()
                        / 2, Core.VIRTUAL_HEIGHT / 2 - 240);
